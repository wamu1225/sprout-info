...
家庭で育てるスプラウトは、畑で大きく育てる野菜（たとえば[ビーツ](/beets-info/cultivation/)のような根菜）とは扱いが異なる。ここでは、この「食べるための新芽を水で育てる」タイプを中心に扱う。
...
上の手順は、最後に光を当てて葉を緑にする「緑化」で仕上げるものである。かいわれ大根やブロッコリースプラウトはこの育て方にあたり、暗いあいだに茎をのばし、子葉が開いたところで明るい室内へ移して緑にする。種苗会社の説明では、暗くして育てるのは、光を遮って発芽と伸長をうながすためで、明るい場所へは急に直射日光に当てず段階的に移すとよいとされる。

いっぽう、豆から育てる「もやし」は、最後まで暗いところで育て、光に当てない。もやし生産者協会によれば、もやしは穀類や豆類の種子を水にひたし、光を遮った容器の中で発芽させて育てたものである。日本で多く出回るのは緑豆、大豆、ブラックマッペのもやしで、光に当てないために全体が白いまま育つ。緑化させる緑豆もやしなどとは、仕上げの考え方がちがう。
...
⚠️ 育てているものが、緑にして食べる種類か、白いまま食べる種類かを先に確かめる。豆もやしを緑化させる必要はなく、かいわれ大根を暗いままにすると緑になりきらない。
