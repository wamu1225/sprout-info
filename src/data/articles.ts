...
家庭で育てるスプラウトは、畑で大きく育てる野菜（たとえば[ビーツ](/beets-info/cultivation/)のような根菜）とは扱いが異なります。ここでは、この「食べるための新芽を水で育てる」タイプを中心に扱います。
...
`,
  ...
  // ───────── 2. 水耕と育苗のちがい ─────────
  {
    ...
    icon: 'git-compare',
    lead: '「ブロッコリースプラウトを育てる」と検索すると、二つのまったく違う話が混ざって出てきます。ここを分けておくと、失敗が減ります。',
...
本サイトが扱うのは、前者の「食べるスプラウトの水耕」です。土も肥料も日光もいらず、台所のそばで育てられます。数日で収穫でき、特別な道具もいらないため、はじめての人でも取り組みやすくなっています。はじめてでも失敗が少なく、道具をそろえる負担も小さくてすみます。具体的な進め方は [栽培の手順](/sprout-info/grow/) で、日ごとに追っていきます。育てる途中で根元に白いものが出て心配になったら、[根毛とカビの見分け](/sprout-info/discern/) も役に立ちます。
`,
    updatedAt: '2026-07-07',
...
⚠️ 育てているものが、緑にして食べる種類か、白いまま食べる種類かを先に確かめます。豆もやしを緑化させる必要はなく、かいわれ大根を暗いままにすると緑になりきりません。
...
しかし、その白いものの多くは**根毛**です。根毛は、水を吸うために根から伸びる細い毛で、水分が足りないときにできやすくなっています。正常なはたらきであり、食べても問題ありません。
...
⚠️ 全体がやわらかくなっている、ぬめりがある、茶色く変色している、酸っぱい嫌なにおいがするといったときは、根毛かカビかを問わず、食べずに処分します。育てているあいだに白いものが気になったら、収穫を待たずに一度、霧吹きで確かめてみるとよいでしょう。早めに気づけば、風通しをよくして水をこまめに替えるなど、手を打ちやすくなります。軽いカビらしきものを取り除いて食べ続けたくなることもありますが、カビは目に見えない部分にも広がっていることがあるため、心配なときはその株ごと処分するのが安全です。ここでの見分けは、植物のつくりにもとづく一般的な目安であり、健康や医療の助言ではありません。少しでも心配なときは、無理をしないでください。生食の安全については [食中毒を防ぐ衛生](/sprout-info/safety/) もあわせて読んでください。
`,
  ...
  // ───────── 5. 衛生・食中毒予防 ─────────
  {
    ...
    icon: 'shield-check',
    lead: 'スプラウトは生で食べることが多い食品です。だからこそ、育て方と扱い方の衛生が大切になります。この点は、公的な指針にもとづいて確かめておきます。',
...
食中毒菌がどこから来るかを知ると、備えの勘どころが分かります。農林水産省によれば、スプラウトに菌が付く経路は、種子、育てる水、作業する人の手などがありますが、なかでも**種子に由来する可能性が最も高い**とされています。種子についたわずかな菌が、発芽から収穫までの数日のあいだに、育てるのに適した温度と湿度のもとで増えていきます。

このことは、家庭での種選びに直結します。食用として売られているスプラウト用の種を使うのが出発点になります。畑にまく栽培用の種は、生で食べることを前提にしておらず、発芽をそろえるために薬剤で処理されていることもあるため、スプラウトには使いません。種の袋の表示を確かめ、食用と書かれたものを選びます。この違いは [スプラウトと育苗のちがい](/sprout-info/vs-seedling/) でも扱っています。
...
⚠️ においやぬめり、変色があるものは、食べずに処分します。妊娠中の人、高齢の人、小さな子ども、体調のすぐれない人は、生で食べるのを避けて加熱する選び方もあります。心配なときは、加熱調理してから食べると、生で食べるよりもリスクを下げられます。育てる容器や調理の道具を清潔に保つことも、安全につながります。生食の判断に迷うときは、無理をしないでください。安全に関わることは、最新の公的な情報に従うのが確実です。
`,
  ...
  // ───────── 6. 選び方・保存・調理 ─────────
  {
    ...
    icon: 'utensils',
    lead: '育てたスプラウトも、買ってきたスプラウトも、新鮮なうちに食べるのがいちばんです。選び方と保存、調理のこつをまとめます。',
    toc: ['選び方', '保存', '調理のこつ'],
    content: `## 選び方
...
`,
  ...
  // ───────── 7. FAQ ─────────
  {
    ...
    icon: 'help-circle',
    lead: 'スプラウトを育てるときによく出てくる疑問に、各ページの要点で答えます。',
